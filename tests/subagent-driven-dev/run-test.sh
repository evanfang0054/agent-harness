...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/agent-harness
...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/agent-harness-tests/$TIMESTAMP/subagent-driven-development"
...
PROMPT="Execute this plan using agent-harness:subagent-driven-development. The plan is at: $PLAN_PATH"
