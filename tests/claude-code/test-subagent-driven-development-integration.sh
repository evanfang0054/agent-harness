...
mkdir -p src test docs/agent-harness/plans

# Create a simple implementation plan
cat > docs/agent-harness/plans/implementation-plan.md <<'EOF'
...
I want you to execute the implementation plan at docs/agent-harness/plans/implementation-plan.md using the subagent-driven-development skill.
...
# IMPORTANT: Run from agent-harness directory so local dev skills are available
PROMPT="Change to directory $TEST_PROJECT and then execute the implementation plan at docs/agent-harness/plans/implementation-plan.md using the subagent-driven-development skill.
...
if grep -q '"name":"Skill".*"skill":"agent-harness:subagent-driven-development"' "$SESSION_FILE"; then
