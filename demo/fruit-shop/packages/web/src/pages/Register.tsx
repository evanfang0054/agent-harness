        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <input
              ...
              placeholder="请输入手机号"
              maxLength={11}
              className="w-full px-4 py-3 rounded-2xl border border-gray-200 bg-white text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-brand-primary/30 focus:border-brand-primary transition-colors"
            />
          </div>
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full py-3.5 bg-brand-primary text-white font-semibold rounded-2xl hover:opacity-90 active:scale-[0.98] disabled:opacity-50 disabled:active:scale-100 transition-all"
          >
            {isLoading ? '注册中...' : '注册'}
          </button>
        </form>
