...
**Spec:** `docs/agent-harness/specs/2026-06-05-design-md-generation-design.md`
**Contract:** `docs/agent-harness/contracts/design-md-generation.contract.md`
...
运行：
```bash
grep -c "^### [0-9]\." /Users/arwen/Desktop/Arwen/evanfang/agent-harness/skills/harness-design/references/design-md-spec.md
```
Expected: `9`
...
运行：
```bash
awk '/^---$/{n++; next} n==1{print}' /Users/arwen/Desktop/Arwen/evanfang/agent-harness/skills/harness-design/SKILL.md | wc -l
```
...
```bash
test -f /Users/arwen/Desktop/Arwen/evanfang/agent-harness/skills/harness-design/references/design-md-spec.md && \
grep -c "^### [0-9]\." /Users/arwen/Desktop/Arwen/evanfang/agent-harness/skills/harness-design/references/design-md-spec.md
```
Expected: 输出 `9`
...
grep -c "DESIGN.md" /Users/arwen/Desktop/Arwen/evanfang/agent-harness/skills/harness-design/SKILL.md
# Expected: ≥ 4（frontmatter + 协议补充 + 路由表 + 工作流 + 核心提醒）

# 改动 2: brand-spec.md 模板本身未被修改
# 定位 SKILL.md 中 brand-spec.md 模板代码块内的关键字段
grep -c "Logo" /Users/arwen/Desktop/Arwen/evanfang/agent-harness/skills/harness-design/SKILL.md
# Expected: 保持原有数量（品牌资产协议的 Logo 字段未删除）

# 改动 3: 路由表新增 DESIGN.md 行
grep -c "生成 DESIGN.md" /Users/arwen/Desktop/Arwen/evanfang/agent-harness/skills/harness-design/SKILL.md
# Expected: ≥ 1

# 改动 4: 工作流末尾步骤
grep -c "工作流末尾 · 生成 DESIGN.md" /Users/arwen/Desktop/Arwen/evanfang/agent-harness/skills/harness-design/SKILL.md
# Expected: 1

# 改动 5: 核心提醒新增
grep -c "生成 DESIGN.md（可选）" /Users/arwen/Desktop/Arwen/evanfang/agent-harness/skills/harness-design/SKILL.md
# Expected: 1
```
...
grep -c "## 🎯 核心资产（一等公民）" /Users/arwen/Desktop/Arwen/evanfang/agent-harness/skills/harness-design/SKILL.md
# Expected: 1

grep -c "## 🎨 辅助资产" /Users/arwen/Desktop/Arwen/evanfang/agent-harness/skills/harness-design/SKILL.md
# Expected: 1
```
...
```bash
grep -c "从 HTML 反向提取 Token 的流程" /Users/arwen/Desktop/Arwen/evanfang/agent-harness/skills/harness-design/references/design-md-spec.md
# Expected: 1
```
...
**Plan complete and saved to `docs/agent-harness/plans/2026-06-05-design-md-generation.md`. Two execution options:**
