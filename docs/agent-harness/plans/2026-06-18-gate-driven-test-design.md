...
**Files:**
- Create: `docs/agent-harness/notes/2026-06-18-gdd-baseline-red.md`（临时观察记录，验证后可删）
...
在 `docs/agent-harness/notes/2026-06-18-gdd-baseline-red.md` 记录：
...
```bash
git add docs/agent-harness/notes/2026-06-18-gdd-baseline-red.md
...
**Files:**
- Modify: `docs/agent-harness/notes/2026-06-18-gdd-baseline-red.md`（追加段落）
...
追加到 `docs/agent-harness/notes/2026-06-18-gdd-baseline-red.md`：
...
Run:
```bash
grep -c 'agent-harness:gate-driven-test-design' skills/brainstorming/SKILL.md
...
grep -q 'agent-harness:gate-driven-test-design' skills/brainstorming/SKILL.md && grep -q 'writing-plans (required)' skills/brainstorming/SKILL.md && echo "DoD6 OK"
```
...
派一个 subagent，给它：
- 本设计 spec 文件路径：`docs/agent-harness/specs/2026-06-18-gate-driven-test-design-design.md`
- GDD skill 三文件路径
...
如 `docs/agent-harness/notes/2026-06-18-gdd-baseline-red.md` 不再需要，删除：
```bash
git rm docs/agent-harness/notes/2026-06-18-gdd-baseline-red.md 2>/dev/null || true
```
如保留作参考，跳过此步。

- [ ] **Step 5: Commit 验证记录**

如产出了干跑 GDD 段样本，保存到 `docs/agent-harness/notes/2026-06-18-gdd-dry-run-sample.md` 并提交：
```bash
git add docs/agent-harness/notes/2026-06-18-gdd-dry-run-sample.md
...
- frontmatter `name: gate-driven-test-design` 与调用方 `agent-harness:gate-driven-test-design` 命名一致
