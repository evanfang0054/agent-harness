...
**Tech Stack:** Bash（`set -euo pipefail`）、`jq`、`claude -p --output-format stream-json --verbose --include-partial-messages`、`gh`、`uvx claude-code-log`、agent-harness skills 插件。

**Spec:** `docs/agent-harness/specs/2026-06-24-auto-loop-self-improvement-design.md`
...
Run: `grep -q "evanfang0054/agent-harness" scripts/auto-loop.sh && echo OK`
