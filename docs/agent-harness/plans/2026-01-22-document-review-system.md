...
> **For agentic workers:** REQUIRED: Use agent-harness:subagent-driven-development (if subagents available) or agent-harness:executing-plans to implement this plan.
...
**Spec:** docs/agent-harness/specs/2026-01-22-document-review-system-design.md
...
**Dispatch after:** Spec document is written to docs/agent-harness/specs/
...
```markdown
> **For agentic workers:** REQUIRED: Use agent-harness:subagent-driven-development (if subagents available) or agent-harness:executing-plans to implement this plan. Tasks and steps use checkbox (`- [ ]`) syntax for tracking.
```
