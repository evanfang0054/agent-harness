...
- Read during verification: `.agent-harness/session-analysis/ac3a4a38-1ae1-4fcc-901d-929eef8e7661.json`
  - Use as the regression fixture input for the final report rerun.
- Update during verification: `.agent-harness/session-analysis/ac3a4a38-1ae1-4fcc-901d-929eef8e7661-report.md`
...
```python
    def test_find_session_file_reports_fallback_source_and_actual_project_dir(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            requested_dir = projects_dir / '-Users-arwen-Desktop-Arwen-evanfang-agent-harness'
    ...
    def test_extract_session_includes_requested_and_actual_provenance_fields(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            extracted = extract_session.extract_session(
                session_file,
                requested_project_path='-Users-arwen-Desktop-Arwen-evanfang-agent-harness',
                actual_project_dir='-Users-arwen-Desktop-Arwen-evanfang-hapi',
                session_source='fallback-global-search',
            )

            self.assertEqual(extracted['requested_project_path'], '-Users-arwen-Desktop-Arwen-evanfang-agent-harness')
...
**Files:**
- Modify: `skills/harness-optimizerr/SKILL.md`
- Read: `.agent-harness/session-analysis/ac3a4a38-1ae1-4fcc-901d-929eef8e7661.json`
- Update: `.agent-harness/session-analysis/ac3a4a38-1ae1-4fcc-901d-929eef8e7661-report.md`
...
```markdown
## Session Provenance
- Requested project: `-Users-arwen-Desktop-Arwen-evanfang-agent-harness`
...
python skills/harness-optimizerr/scripts/analyze-session.py \
  --input .agent-harness/session-analysis/ac3a4a38-1ae1-4fcc-901d-929eef8e7661.json \
  --output .agent-harness/session-analysis/ac3a4a38-1ae1-4fcc-901d-929eef8e7661-report.md
```
...
```bash
git add skills/harness-optimizerr/SKILL.md skills/harness-optimizerr/tests/test_session_optimizer.py .agent-harness/session-analysis/ac3a4a38-1ae1-4fcc-901d-929eef8e7661-report.md
