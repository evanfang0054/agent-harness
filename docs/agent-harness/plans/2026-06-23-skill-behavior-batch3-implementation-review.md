...
```
/agent-harness:test-driven-development Implement a stack data structure with push, pop, and peek methods.
```
...
Plan complete and saved to `docs/agent-harness/plans/2026-06-23-skill-behavior-batch3-implementation-review.md`.
